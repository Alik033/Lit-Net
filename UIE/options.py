...
parser.add_argument('--data_path', default='../UFO_Train/')
parser.add_argument('--scale', type=int, default=2)

parser.add_argument('--checkpoints_dir', default='./ckpt_UFO/')
parser.add_argument('--batch_size', type=int, default=5)

parser.add_argument('--learning_rate_g', type=float, default=2e-04)

parser.add_argument('--end_epoch', type=int, default=152)
...
parser.add_argument('--testing_dir_inp', default="../UFO_Test/LR/")
parser.add_argument('--testing_dir_gt', default="../UFO_Test/HR/")
