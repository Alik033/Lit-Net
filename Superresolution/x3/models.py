...
class LitNet(nn.Module):
    ...
    def __init__(self, scale):
        ...
        ##########################################################
        self.con_pad = nn.Conv2d(64,64,kernel_size = (2,1), padding=(1,0))
        self.con_pad1 = nn.Conv2d(64,64,kernel_size = (2,1), padding=(0,0))
        ...
        self.convf_1 = Conv2D_pxp(64, 3*scale*scale, 3,1,1)
        self.pixel_shuffle = nn.PixelShuffle(scale)

        self.bi_ups = nn.Upsample(scale_factor=3, mode='bicubic')
        self.f_conv = nn.Conv2d(3,3,kernel_size=(3,1),padding=0)
